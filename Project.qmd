...
def update_plot(change):
    ...
    fig = px.line(filtered_data, x='year', y='tb_death', title=f'Evolution of TB Death in {country}')
    clear_output(wait=True)
    display(country_dropdown, refresh_button)
    fig.show()


# Display the dropdown menu, button, and plot
...
def update_plot(change):
    ...
    country = country_dropdown.value
    filtered_data = data[data['country'] == country]
    fig = px.histogram(filtered_data, x='year', y='vac_status', title=f'Evolution of BCG vaccine in {country}')
    clear_output(wait=True)
    display(country_dropdown, refresh_button)
    fig.show()
